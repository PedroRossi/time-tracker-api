...
class AuthenticationsController < ApplicationController
  ...
  def create
    ...
    options = { :body => {:code => code, :redirect_uri => redirect_uri, :grant_type => "authorization_code", :client_id => "766044722529-hnq5ohm4o3f4jclfs3dq6plgt3ad7nmk.apps.googleusercontent.com", :client_secret => ENV['GOOGLE_OAUTH_SECRET'] } }
